...
export function ContactTemplate() {
  ...
  async function SubmitedContactForm(form: formData) {
    setLoading(true);
        ...
        <SizedContainer>
          <S.Container>
            <S.ContactInfoContainer>
              ...
              <Heading3>Get in touch by:</Heading3>
              <S.ContactInfoGroup>
                <MutedText>By filling the contact form.</MutedText>
                <MutedText>
                  By E-mail: ‎ ‎
                  <Link href="mailto:contact@alvez.dev" passHref>
                    <S.ContactInfoLink>contact@alvez.dev</S.ContactInfoLink>
                  </Link>
                </MutedText>
                <MutedText>
                  By ‎ ‎
              ...
              <S.ContactInfoGroup>
                <MutedText>I’m based in Tubarão, Brazil (BRT)</MutedText>
                <Link
                  href="https://www.zeitverschiebung.net/en/city/3445993"
                  passHref
                  about="see local time details"
                >
                  <S.ContactInfoLink>
              ...
              <S.ContactInfoGroup>
                <MutedText>want to check out my github?</MutedText>
                <Link
            ...
            <S.ContactForm onSubmit={handleSubmit(SubmitedContactForm)}>
              <MutedText>
                Got an exciting idea? Let me know it, if you want to work
