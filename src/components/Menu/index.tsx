...
export function Menu() {
  ...
  return (
    <NavBar initial={false} animate={isOpen ? 'menuOpen' : 'menuClosed'}>
      <SizedContainer>
        <MenuContainer initial={false} variants={variants}>
          <NavCollumn>
            <MutedText>Navigation</MutedText>
            <DividerMenuLine />
        ...
        <ContainerNonFloatButtons>
          <Heading3 onClick={() => toggleOpen()}>menu</Heading3>
          <MenuDesktopContainer>
            <MenuDesktopItem>
              <Heading3 as="a" href="/">
                Home
